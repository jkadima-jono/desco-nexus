  ...
  return (
    <div ref={containerRef} className="relative">
      <Button
        ...
        className="relative flex min-h-11 min-w-11 items-center justify-center  text-white/70 hover:bg-white/10 hover:text-white"
      >
        <span aria-hidden="true">🔔</span>
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 min-w-[16px] h-4 px-1 bg-brandred text-white text-[10px] font-bold flex items-center justify-center">
      ...
      {open && (
        <div
          ...
          className="fixed inset-x-4 bottom-20 z-[60] max-h-[60vh] overflow-y-auto  border border-charcoal/10 bg-white text-charcoal  lg:absolute lg:inset-x-auto lg:bottom-full lg:right-0 lg:mb-2 lg:w-80 lg:max-h-96"
        >
          <div className="flex items-center justify-between border-b border-charcoal/10 px-4 py-2">
            ...
            <Button type="button" onClick={closeAndRestoreFocus} className="min-h-11 min-w-11  text-xl" aria-label={copy.closeNotifications}>×</Button>
          </div>

...
const fr = {
  ...
  "tilu-pepm-8252": {
    ...
    summary: "Prospect cuivre-cobalt-or précoce dans le territoire de Manono. Une étude historique mentionne le permis de recherches 8252, accordé en juillet 2007, et une campagne géochimique de 2010 comprenant 933 échantillons de sol. Les renouvellements, le titulaire actuel et la validité du permis n’ont pas été vérifiés.",
...
const esCopy: Record<string, Pick<ListingText, "summary" | "highlights" | "whyMatch">> = {
  ...
  "tilu-pepm-8252": {
    summary: "Prospecto temprano de cobre, cobalto y oro en Manono. Un estudio histórico registra el permiso de investigación 8252, concedido en julio de 2007, y una campaña geoquímica de 2010 con 933 muestras de suelo. No se han verificado las renovaciones, la titularidad actual ni la vigencia del permiso.",
...
const zhCopy: Record<string, Pick<ListingText, "summary" | "highlights" | "whyMatch">> = {
  ...
  "tilu-pepm-8252": { summary: "位于 Manono 的早期铜、钴、金勘探项目。历史研究记录 8252 号勘探许可证于 2007 年 7 月获批，以及 2010 年完成的 933 个土壤样本地球化学工作。后续续期、当前持有人及许可证现状尚未核实。", highlights: ["约 89 平方公里范围内 24 条南北向测线共 933 个样本", "铜最高 581 ppm、钴最高 7,490 ppm；这些数值不构成资源量", "2007 年许可证列明铜、钴和金；当前续期及有效性有待确认"], whyMatch: "Investdesco 早期采矿项目，适合能够评估资源量确定前地质及矿权风险的投资者。" },

...
const en: MarketingCopy = {
  home: {
    metadata: { title: "DESCO Compass — DRC project preparation and disclosure", description: "See how DESCO applies a consistent disclosure standard, dated sources and controlled diligence to DRC project files." },
  ...
  about: {
    ...
    hero: { eyebrow: "About DESCO Global", title: "We connect structured projects, capital and strategic partners.", body: "We operate DESCO Compass as a project-preparation and disclosure platform focused initially on the Democratic Republic of the Congo, with the capacity to support selected African markets.", primary: "Contact DESCO Global", secondary: "Review investment pillars" },
  ...
  pricing: {
    ...
    pathsEyebrow: "Primary proposed service", pathsTitle: "Project preparation is the current commercial priority.",
    pathsBody: "DESCO currently prioritises scoped sponsor preparation work. Investor and programme workspaces remain proposed pathways that require separate legal, service and commercial approval.",
    paths: [
...
const fr: MarketingCopy = {
  ...
  home: {
    ...en.home,
    metadata: { title: "DESCO Compass — Préparation et divulgation des projets en RDC", description: "Découvrez comment DESCO applique une norme de divulgation cohérente, des sources datées et une diligence contrôlée aux dossiers de projets en RDC." },
  ...
  pricing: {
    ...
    pathsEyebrow: "Service proposé en priorité", pathsTitle: "La préparation des projets est la priorité commerciale actuelle.", pathsBody: "DESCO donne actuellement la priorité aux missions de préparation définies avec les porteurs. Les espaces investisseurs et programmes restent des parcours proposés soumis à une approbation juridique, opérationnelle et commerciale distincte.",
    paths: [
...
function completeTranslation(locale: "es" | "pt" | "zh"): MarketingCopy {
  ...
  return {
    home: {
      metadata: {
        title: tr("DESCO Compass — Preparación y divulgación de proyectos en la RDC", "DESCO Compass — Preparação e divulgação de projetos na RDC", "DESCO Compass — 刚果民主共和国项目准备与披露"),
        description: tr("Vea cómo DESCO aplica una norma de divulgación coherente, fuentes fechadas y diligencia controlada a los expedientes de proyectos en la RDC.", "Veja como a DESCO aplica uma norma de divulgação coerente, fontes datadas e diligência controlada aos dossiês de projetos na RDC.", "了解 DESCO 如何将统一披露标准、注明日期的来源和受控尽调应用于刚果民主共和国项目文件。"),
      },
    ...
    about: {
      ...
      hero: { eyebrow: tr("Acerca de DESCO Global", "Sobre a DESCO Global", "关于 DESCO Global"), title: tr("Conectar proyectos estructurados, capital y socios estratégicos.", "Ligar projetos estruturados, capital e parceiros estratégicos.", "连接结构化项目、资本与战略合作伙伴。"), body: tr("Operamos DESCO Compass como plataforma de preparación y divulgación de proyectos, centrada inicialmente en la RDC y con capacidad para apoyar mercados africanos seleccionados.", "Operamos a DESCO Compass como plataforma de preparação e divulgação de projetos, inicialmente centrada na RDC e com capacidade para apoiar mercados africanos selecionados.", "我们运营 DESCO Compass 项目准备与信息披露平台，初期重点覆盖刚果民主共和国，并可支持部分非洲市场。"), primary: tr("Contactar con DESCO Global", "Contactar a DESCO Global", "联系 DESCO Global"), secondary: tr("Revisar los pilares de inversión", "Analisar os pilares de investimento", "查看投资业务支柱") },
...
function translatedPricing(locale: "es" | "pt" | "zh", tr: Tr, card: CardFactory): MarketingCopy["pricing"] {
  return {
    ...
    pathsEyebrow: tr("Servicio propuesto prioritario", "Serviço proposto prioritário", "优先拟议服务"),
    pathsTitle: tr("La preparación de proyectos es la prioridad comercial actual.", "A preparação de projetos é a prioridade comercial atual.", "项目准备是当前商业重点。"),
    pathsBody: tr("DESCO prioriza actualmente encargos de preparación definidos con los promotores. Los espacios de inversores y programas siguen siendo vías propuestas sujetas a aprobación jurídica, operativa y comercial separada.", "A DESCO dá atualmente prioridade a trabalhos de preparação definidos com os promotores. Os espaços de investidores e programas continuam propostos e sujeitos a aprovação jurídica, operacional e comercial separada.", "DESCO 当前优先开展与项目发起方约定范围的项目准备工作。投资者及计划工作区仍属拟议路径，须另行获得法律、服务和商业批准。"),
    paths: [

...
const fr: MarketingCopy = {
  ...
  home: {
    ...
    processCta: "Examiner le processus complet de diligence", trustEyebrow: "Confiance et divulgation", trustTitle: "Les statuts d’examen et les contrôles d’accès sont définis explicitement.", trustBody: "La plateforme distingue les informations publiques, fournies par le porteur, examinées par DESCO, restreintes et vérifiées indépendamment. Aucun statut ne constitue une approbation d’investissement.",
    controls: [
...
function completeTranslation(locale: "es" | "pt" | "zh"): MarketingCopy {
  ...
  return {
    home: {
      ...
      trustBody: tr("La plataforma distingue información pública, proporcionada por el promotor, revisada por DESCO, restringida y verificada de forma independiente. Ningún estado constituye respaldo de inversión.", "A plataforma distingue informação pública, fornecida pelo promotor, analisada pela DESCO, restrita e verificada de forma independente. Nenhum estado constitui aprovação de investimento.", "平台区分公开信息、发起方提供的信息、DESCO 已审查信息、受限信息和独立核实信息。任何状态均不构成投资认可。"),
      controls: [
...
export function getMarketingMetadata(locale: Locale, page: keyof MarketingCopy): Metadata {
  return COPY[locale][page].metadata;
}

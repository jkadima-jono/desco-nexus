...
type InvestmentUi = {
  ...
  card: {
    ...
    updated: string; evidence: string; risks: string; review: string; relatedParty: string;
  };
  images: {
...
const en: InvestmentUi = {
  opportunities: {
    metadataTitle: "Opportunities — DESCO Compass", metadataDescription: "Review structured African investment opportunity teasers by sector, geography, stage, instrument and capital requirement.",
  ...
  card: { capitalSought: "capital sought", capitalNotDisclosed: "capital requirement not publicly disclosed", reviewed: "DESCO evidence review recorded", pending: "Sponsor-provided · review pending", sponsor: "Sponsor", updated: "Updated", evidence: "Public disclosure", risks: "Risks addressed", review: "Review", relatedParty: "DESCO-related opportunity" },
  images: { regional: "Regional visual · replaceable", example: "Example visual · replaceable", preview: "Preview", previewDialog: "Project image preview", closePreview: "Close image preview", replaceVisual: "Replace visual", captionSource: "Image caption and source", captionPlaceholder: "What the image shows · source or owner · month/year", uploadHelp: "Uploading an approved sponsor image replaces the current regional or example visual across project cards and this page.", noApproved: "No approved public project imagery is available.", sponsorImage: "Sponsor-provided project image" },
  contact: {
    ...
    fullName: "Full name", email: "Email", organization: "Organization", optional: "optional", topic: "Topic", message: "Message", sending: "Sending…", send: "Send message", received: "Message received", receivedBody: "A DESCO team member will review the inquiry. No response time is guaranteed in this demonstration environment.", retry: "Could not send. Please retry.", network: "Network error. Please retry.", acknowledgement: "I understand that DESCO Compass is a demonstration environment and that its full privacy notice and terms are pending legal review. See the", legalStatus: "current legal and privacy status",
...
const zh: InvestmentUi = {
  ...
  card: { capitalSought: "融资需求", capitalNotDisclosed: "融资需求尚未公开披露", reviewed: "已记录 DESCO 证据审查", pending: "项目发起方提供 · 等待审查", sponsor: "项目发起方", updated: "更新于", evidence: "公开披露", risks: "已说明风险", review: "审阅", relatedParty: "DESCO 关联机会" },
  images: { regional: "地区参考图 · 可替换", example: "示例图 · 可替换", preview: "预览", previewDialog: "项目图片预览", closePreview: "关闭图片预览", replaceVisual: "替换图片", captionSource: "图片说明与来源", captionPlaceholder: "图片内容 · 来源或所有者 · 月/年", uploadHelp: "上传经批准的项目发起方图片后，将替换项目卡片和本页的地区参考图或示例图。", noApproved: "暂无经批准的公开项目图片。", sponsorImage: "项目发起方提供的图片" },
  contact: { ...en.contact, metadataTitle: "联系 DESCO Compass", metadataDescription: "就投资机会、合作或平台权限联系 DESCO Global。", title: "联系我们", intro: "请选择咨询目的，以便转交相应的投资者、项目发起方、合作或支持流程。", notice: "工作区批准与特定项目数据室权限是两项独立决定。提交表单不会授予权限，也不代表完成投资者资格审查。", fullName: "姓名", email: "电子邮箱", organization: "机构", optional: "选填", topic: "主题", message: "留言", sending: "发送中…", send: "发送留言", received: "留言已收到", receivedBody: "DESCO 团队成员将审阅咨询。本演示环境不保证回复时限。", retry: "发送失败，请重试。", network: "网络错误，请重试。", acknowledgement: "我了解 DESCO Compass 属于演示环境，完整隐私声明及使用条款仍待法律审核。请参阅", legalStatus: "当前法律与隐私状态", topics: { general: "一般咨询", "investor-access": "投资者工作区权限", "project-submission": "提交项目", "data-room": "数据室权限问题", "institutional-partnership": "机构合作", "commercial-model": "商业范围与工作区模式", "government-dfi": "政府或开发金融机构合作", "inaccurate-information": "报告不准确的项目信息", "technical-support": "技术支持" } },

...
const pt: InvestmentUi = {
  ...
  images: { ...es.images, regional: "Contexto regional · local não confirmado", example: "Visual conceptual · imagem do projeto pendente", preview: "Pré-visualizar", previewDialog: "Pré-visualização da imagem do projeto", closePreview: "Fechar pré-visualização", replaceVisual: "Substituir imagem", captionSource: "Legenda e fonte da imagem", captionPlaceholder: "Conteúdo · fonte ou proprietário · mês/ano", uploadHelp: "Uma imagem aprovada do promotor substituirá a imagem regional ou conceptual.", noApproved: "Não existem imagens públicas aprovadas.", sponsorImage: "Imagem fornecida pelo promotor" },
...
const zh: InvestmentUi = {
  ...
  images: { regional: "区域背景 · 地点未经确认", example: "概念图 · 项目图片待补充", preview: "预览", previewDialog: "项目图片预览", closePreview: "关闭图片预览", replaceVisual: "替换图片", captionSource: "图片说明与来源", captionPlaceholder: "图片内容 · 来源或所有者 · 月/年", uploadHelp: "上传经批准的项目发起方图片后，将替换项目卡片和本页的区域背景图或概念图。", noApproved: "暂无经批准的公开项目图片。", sponsorImage: "项目发起方提供的图片" },

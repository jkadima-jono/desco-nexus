    ...
    <div className="min-h-screen bg-ink flex items-center justify-center px-6 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-[0_12px_32px_rgb(0_0_0/0.4)]">
          <h1 className="font-display font-bold text-xl mb-1">{demoEnabled ? t("login.demoTitle") : t("login.accessTitle")}</h1>
          ...
          <p className="text-xs text-wgray mt-5 leading-relaxed">
            {t(demoEnabled ? "login.demoNote" : "login.accessNote")}
          </p>
